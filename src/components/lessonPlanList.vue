<template>
    <div class="lessonPlanList fillcontain">
        <el-form :inline="true" :model="gradeForm" class="lessonPlanList-form">
        ...
        <el-table ref="singleTable" :data="tableData" highlight-current-row @current-change="handleCurrentRow" style="width: 100%">
            ...
            <el-table-column prop="planFilename" label="教案" min-width="200">
            </el-table-column>
            <el-table-column prop="planLesson" label="單元" width="100">
            </el-table-column>
            <el-table-column prop="planHashtag" label="標籤" min-width="100">
            </el-table-column>
            <el-table-column prop="createBy" label="上傳者" width="100">
            </el-table-column>
            <el-table-column label="操作" width="180">
                <template slot-scope="scope">
                    <!-- <el-button size="small" @click="handleEdit(scope.row)">下載</el-button> -->
                    <el-button size="small">
                        <a :href="url+ scope.row.planFileurl">下載</a>
                    </el-button>
        ...
        <!-- <el-dialog title="修改單字信息" :visible.sync="dialogFormVisible">
                    <el-form ref="form" :model="form" label-width="80px">
                        ...
                        <el-form-item label="難易程度" prop="wordLevel">
                            <el-input v-model="form.wordLevel" placeholder="請輸入單字的難易程度"></el-input>
                        </el-form-item>
                    </el-form>
...
<script>
import qs from 'qs'
import {lessonPlan_list_url,lessonPlan_delete_url,lessonPlan_download_url} from '@/config/api'
export default {
    data() {
        return {
            tableData: [],
    ...
    methods: {
        ...
        deleteData(row) {
            this.$http.post(lessonPlan_delete_url, qs.stringify({ planId: row.planId }))
                .then(response => {
        ...
        //     this.$http.post('http://127.0.0.1:8080/elearning/word/insert', qs.stringify(this.form))
        //         .then(response => {
        //             if (response.data.code == 0) {
        //                 this.$message({
        //                     type: 'success',
        ...
        // },
        getData() {
            this.$http.get(lessonPlan_download_url, {
                params: {
