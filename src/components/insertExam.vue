<template>
    <div class="insertExam fillcontain">
        <el-form :inline="true" :model="gradeForm" class="exam-form" v-loading.fullscreen.lock="fullscreenLoading">
            ...
            <el-form-item>
                <el-button type="primary" @click="onSubmit">自動出卷</el-button>
            </el-form-item>
        </el-form>
        <el-dialog title="自動產生的試卷" :visible.sync="dialogFormVisible" size="large">
                ...
                <div class="question-area" v-for="(question, index) in exam.questionDTOList" :key="question.key">
                    ...
                    <div class="question-area-question-wrapper" v-for="answer in question.answerDTOList" :key="answer.key">
                        ...
                        <div class="question-area-answer">
                            <p>
                                <el-radio class="radio" v-model="answer.seletvalue" :label="answer.answerContent[0]">{{answer.answerContent[0]}}</el-radio>
                            </p>
                            <p>
                                <el-radio class="radio" v-model="answer.seletvalue" :label="answer.answerContent[1]">{{answer.answerContent[1]}}</el-radio>
                            </p>
                            <p>
                                <el-radio class="radio" v-model="answer.seletvalue" :label="answer.answerContent[2]">{{answer.answerContent[2]}}</el-radio>
                            </p>
                            <p>
                                <el-radio class="radio" v-model="answer.seletvalue" :label="answer.answerContent[3]">{{answer.answerContent[3]}}</el-radio>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="saveExam()">確 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
